...
.ant-table.ant-table-bordered tr.ant-table-expanded-row > td,
.ant-table.ant-table-bordered tr.ant-table-placeholder > td {
  border-right: 0;
}
...
:root .ant-table-column-sorter-up,
:root .ant-table-column-sorter-down {
  font-size: 12px;
}
...
:root .ant-table-selection-extra .anticon {
  font-size: 12px;
}
...
.ant-table tbody > tr > td .ant-table td {
  background: transparent;
}
.ant-table tbody > tr > td .ant-table tbody > tr:last-child > td {
  border-bottom: 0;
}
.ant-table tbody > tr > td .ant-table tbody > tr:last-child > td:first-child,
.ant-table tbody > tr > td .ant-table tbody > tr:last-child > td:last-child {
  border-radius: 0;
}
.ant-table-title {
  border-radius: 2px 2px 0 0;
