...
function Table(props) {
  ...
  return React.createElement("div", {
    ...
    prefixCls: prefixCls,
    className: (0, _classnames["default"])(className, (_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-middle"), size === 'middle'), _defineProperty(_classNames2, "".concat(prefixCls, "-small"), size === 'small'), _defineProperty(_classNames2, "".concat(prefixCls, "-bordered"), bordered), _classNames2)),
    data: pageData,
    rowKey: getRowKey,
