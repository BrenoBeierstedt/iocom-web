...
var BasicLayout = function BasicLayout(props) {
  ...
  var _getMenuData = getMenuData(routes, menu, formatMessage, menuDataRender),
      ...
      breadcrumbMap = _getMenuData.breadcrumbMap,
  ...
  var _useState3 = useState('100%'),
      ...
      setContentSize = _useState4[1]; // warning info
  ...
  return React.createElement(React.Fragment, null, React.createElement(Helmet, null, React.createElement("title", null, pageTitleInfo.title)), React.createElement("div", {
    className: className
    ...
    style: Object.assign(Object.assign({}, contentStyle), {
  ...
  }, React.createElement("div", null, loading ? React.createElement(PageLoading, null) : children)))), footerDom))));
};
