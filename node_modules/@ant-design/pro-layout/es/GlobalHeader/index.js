...
function (_Component) {
  ...
  _createClass(GlobalHeader, [{
    ...
    value: function render() {
      ...
      var logoDom = React.createElement("a", {
      ...
      return React.createElement("div", {
        className: className,
        style: style
      }, isMobile && renderLogo(menuHeaderRender, logoDom), this.renderCollapsedButton(), rightContentRender && rightContentRender(this.props));
    }
  }]);
