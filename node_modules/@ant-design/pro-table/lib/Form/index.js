  ...
  if (!item.valueType || item.valueType === 'text') {
    ...
    if (valueEnum) {
      return _react.default.createElement(_select.default, Object.assign({
        ...
        key: "all",
        value: "all"
      }, "\u5168\u90E8"), (0, _util.parsingValueEnumToArray)(valueEnum).map(function (_ref2) {
...
var FormSearch = function FormSearch(_ref3) {
  ...
  return _react.default.createElement(_configProvider.ConfigConsumer, null, function (_ref4) {
    ...
    }, "\u91CD\u7F6E"), columnsList.length > 2 && _react.default.createElement("a", {
      style: {
        marginLeft: 8
      },
      onClick: function onClick() {
    ...
    }, collapse ? '展开' : '收起', ' ', _react.default.createElement(_icons.DownOutlined, {
      style: {
        transition: '0.3s all',
