export default {
  ...
  'new-password.password.placeholder': 'Senha',
  'new-password.confirm-password.required': 'Confirme a nova senha por favor!',
  ...
  'new-password.strength.short': 'Força: Fraca',
  'new-password.strength.msg':
    "Por favor, insira ao menos 6 caracteres.",

  'userandregister.login.email': 'email',
